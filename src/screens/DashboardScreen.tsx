...
import { getSummary, logout, Summary } from '../api';
...
const styles = StyleSheet.create({
  ...
  h: { color: colors.text, fontSize: 26, fontWeight: '800', marginBottom: 16 },
  ...
  primary: { backgroundColor: colors.accent, borderRadius: 14, padding: 16, marginTop: 22, alignItems: 'center' },
